...
<section class="search_section_head" style="background-image: url(../assets/images/menbg.png);">
  ...
  <div class="hero-title">
    <h1 class="main-title">Adult Pant</h1>
  </div>
            ...
            <div class="swiper-container gallery-thumbs">
              ...
              <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                  <img src="{{url('')}}/assets/images/products/underpants.webp" alt="">
                </div>
                <div class="swiper-slide">
                  <img src="{{url('')}}/assets/images/products/adultswipes.webp" alt="">
                </div>
                <div class="swiper-slide">
                  <img src="{{url('')}}/assets/images/products/underpants.webp" alt="">
                </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="featureImage">
            <img src="{{url('')}}/assets/images/features/adultpants.webp" alt="Features Images">
          </div>
        </div>
      </div>
    </div>
